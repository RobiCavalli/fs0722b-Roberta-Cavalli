...
/* let epi = 'EPICODE';
/*function per compare il carattere I/esimo di due stringhe  */
 /* function epify (str) {
    let textStr = str.substring (0,7) 
    if (textStr != epi){ return str = epi + str;} /* prende la sottostringa dei primi sei caratteri 
}
...
/* SCRIVI QUI LA TUA RISPOSTA */
 ...
 /* function reverseString(str){
    let strReversed = []; /*serve a contenere i caratteri in ordine inverso 
    let rev = ''; /*conterrà la stringa invertita
    for  ( let ì = 0 ; i < str.lenght; i++){
